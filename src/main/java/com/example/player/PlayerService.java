...
public class PlayerService implements PlayerRepository {
    ...
    public ArrayList<Player> getPlayers() {
        ...
        ArrayList<Player> player = new ArrayList<>(playersCollection);
        return player;
    }
    ...
    public Player updatePlayer(int playerId, Player player) {
        ...
        int getj = player.getJerseyNumber();
        String value = String.valueOf(getj);
        int getJersey = Integer.parseInt(value);
